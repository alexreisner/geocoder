...
class CalculationsTest < Test::Unit::TestCase
  ...
  def test_cluster_coordinates
    ...
    assert_equal clusters, [{[52.3941887, 13.072691000000003]=>3}] # One cluster above those three coordinates, centered where most coordinates are
    ...
    assert_equal clusters, [{[52.474657748317775, 13.310132265262823]=>3}] # One cluster above those three coordinates, geographically centered
    ...
    assert_equal clusters, [{[52.50941559999999, 13.453396199999998]=>2}, {[52.3941887, 13.072691000000003]=>1}] # Two clusters, only two coordinates are close enough to be merged
    ...
    assert_equal clusters, [{[52.50941559999999, 13.453396199999998]=>2}] # Only one cluster because of limitation
  end
end
